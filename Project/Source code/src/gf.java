...
public class gf
{
    ...
    private static final Interpolator v = new gg();
    private int a;
    private int b;
    private int c;
    private float d[];
...
_L6:
    ...
    {
        int i1 = cy.c(motionevent);
        for (int j1 = 0; j1 < i1; j1++)
        {
            int k1 = cy.b(motionevent, j1);
            float f1 = cy.c(motionevent, j1);
            float f2 = cy.d(motionevent, j1);
            f[k1] = f1;
            g[k1] = f2;
        }
    ...
    private void h()
    {
        ...
        a(a(de.a(l, c), n, m), a(de.b(l, c), n, m));
    }
    ...
    public boolean a(int i1, int j1)
    {
        ...
        {
            return a(i1, j1, (int)de.a(l, c), (int)de.b(l, c));
        }
    }
...
_L2:
        ...
        if ((i3 & p) != 0)
        {
          ...
          goto _L7
_L5:
        int j2 = cy.b(motionevent, j1);
        float f5 = cy.c(motionevent, j1);
        float f6 = cy.d(motionevent, j1);
        a(f5, f6, j2);
        if (a == 0)
        {
            int k2 = h[j2];
...
_L8:
        i2 = cy.b(motionevent, l1);
        f1 = cy.c(motionevent, l1);
        f2 = cy.d(motionevent, l1);
        f3 = f1 - d[i2];
        f4 = f2 - e[i2];
        b(f3, f4, i2);
...
_L6:
        ...
        float f10;
        int j4;
        i4 = cy.b(motionevent, k1);
        f9 = cy.c(motionevent, k1);
        f10 = cy.d(motionevent, k1);
        a(f9, f10, i4);
        if (a != 0)
        {
...
_L4:
        ...
        if (a == 1)
        {
            int j3 = cy.a(motionevent, c);
            float f7 = cy.c(motionevent, j3);
            float f8 = cy.d(motionevent, j3);
            int k3 = (int)(f7 - f[c]);
            int l3 = (int)(f8 - g[c]);
...
_L10:
        ...
        float f5;
        float f6;
        i3 = cy.b(motionevent, i1);
        f3 = cy.c(motionevent, i1);
        f4 = cy.d(motionevent, i1);
        f5 = f3 - d[i3];
        f6 = f4 - e[i3];
        b(f5, f6, i3);
...
_L13:
        i1++;
          goto _L14
_L7:
        int l1 = cy.b(motionevent, k1);
        if (a != 1 || l1 != c) goto _L16; else goto _L15
_L15:
        int i2 = cy.c(motionevent);
_L21:
        if (i1 >= i2) goto _L18; else goto _L17
_L17:
        int k2 = cy.b(motionevent, i1);
...
_L20:
        float f1;
        float f2;
        f1 = cy.c(motionevent, i1);
        f2 = cy.d(motionevent, i1);
