...
public class SlidingPaneLayout extends ViewGroup
{
    ...
    public static ArrayList a(SlidingPaneLayout slidingpanelayout)
    {
    ...
    {
        int i1 = 0;
        fy fy1 = (fy)g.getLayoutParams();
        boolean flag;
        int j1;
        if (fy1.c && fy1.leftMargin <= 0)
        {
            flag = true;
        } else
        {
    ...
    {
        fy fy1 = (fy)view.getLayoutParams();
        if (f1 > 0.0F && i1 != 0)
        {
            ...
            fy1.d.setColorFilter(new PorterDuffColorFilter(j1, android.graphics.PorterDuff.Mode.SRC_OVER));
            if (dj.d(view) != 2)
            {
                dj.a(view, 2, fy1.d);
            }
        ...
        if (dj.d(view) != 0)
        {
            if (fy1.d != null)
            {
                fy1.d.setColorFilter(null);
            }
            fx fx1 = new fx(this, view);
            t.add(fx1);
            dj.a(this, fx1);
            return;
        }
...
label0:
    ...
    boolean a(float f1, int i1)
    {
        ...
        fy fy1 = (fy)g.getLayoutParams();
        int j1 = (int)((float)(getPaddingLeft() + fy1.leftMargin) + f1 * (float)j);
    ...
    {
        return (layoutparams instanceof fy) && super.checkLayoutParams(layoutparams);
    }
...
label0:
    ...
    protected boolean drawChild(Canvas canvas, View view, long l1)
    {
        ...
        if (fy1.c && h > 0.0F)
        {
            ...
            if (bitmap != null)
            {
                canvas.drawBitmap(bitmap, view.getLeft(), view.getTop(), fy1.d);
                flag = false;
            } else
            {
    ...
    protected android.view.ViewGroup.LayoutParams generateLayoutParams(android.view.ViewGroup.LayoutParams layoutparams)
    {
        ...
        {
            return new fy((android.view.ViewGroup.MarginLayoutParams)layoutparams);
        } else
        {
            return new fy(layoutparams);
        }
    }
    ...
    protected void onLayout(boolean flag, int i1, int j1, int k1, int l1)
    {
        ...
        while (j3 < i3) 
        {
            ...
            } else
            {
                ...
                if (fy1.b)
                {
                    int i5 = fy1.leftMargin + fy1.rightMargin;
                    int j5 = Math.min(j2, i2 - k2 - e) - k3 - i5;
                    j = j5;
                    int l4;
                    boolean flag1;
                    if (j5 + (k3 + fy1.leftMargin) + i4 / 2 > i2 - k2)
                    {
                        flag1 = true;
                    } else
                    {
                    ...
                    fy1.c = flag1;
                    j4 = k3 + ((int)((float)j5 * h) + fy1.leftMargin);
                    k4 = 0;
                } else
                if (f && l != 0)
                {
...
_L8:
        ...
        k3 = 0;
          goto _L13
        int l6 = fy2.leftMargin + fy2.rightMargin;
        int i7;
        int j7;
        int k7;
        int l7;
        ...
        {
            i7 = android.view.View.MeasureSpec.makeMeasureSpec(fy2.width, 0x40000000);
        }
        if (fy2.height == -2)
        {
        ...
        {
            j7 = android.view.View.MeasureSpec.makeMeasureSpec(fy2.height, 0x40000000);
        }
        view1.measure(i7, j7);
            ...
            while (i5 < i4) 
            {
                ...
                if (view.getVisibility() != 8)
                {
                    ...
                    if (view.getVisibility() != 8)
                    {
                        ...
                        if (flag && view != g)
                        {
                            if (fy1.width < 0 && (j5 > l4 || fy1.a > 0.0F))
                            {
                                int k6;
                                if (flag1)
                                {
                                    ...
                                    {
                                        k6 = android.view.View.MeasureSpec.makeMeasureSpec(fy1.height, 0x40000000);
                                    }
                                } else
                                {
                        ...
                        if (fy1.a > 0.0F)
                        {
                            ...
                            if (fy1.width == 0)
                            {
                                ...
                                {
                                    k5 = android.view.View.MeasureSpec.makeMeasureSpec(fy1.height, 0x40000000);
                                }
                            } else
                            {
                            ...
                            if (flag)
                            {
                                int i6 = l2 - (fy1.leftMargin + fy1.rightMargin);
                            ...
                            } else
                            {
                                ...
                                view.measure(android.view.View.MeasureSpec.makeMeasureSpec(j5 + (int)((fy1.a * (float)l5) / f1), 0x40000000), k5);
                            }
                        }
                    }
                }
...
_L15:
    ...
    public void setPanelSlideListener(fz fz)
    {
        o = fz;
    }
    ...
    private class SavedState extends android.view.View.BaseSavedState
    {
        ...
        public SavedState(Parcel parcel, fw fw)
        {
            this(parcel);
        }
