    ...
    implements Parcelable
{
    ...
    public Fragment a(n n1, Fragment fragment)
    {
        if (k != null)
        {
            return k;
        ...
        if (i != null)
        {
            i.setClassLoader(n1.getClassLoader());
        }
        k = Fragment.instantiate(n1, a, i);
        if (j != null)
        {
            j.setClassLoader(n1.getClassLoader());
