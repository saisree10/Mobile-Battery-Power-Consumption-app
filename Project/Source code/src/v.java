...
public final class v extends t
{
    ...
    public int a(h h1)
    {
        ...
        if (a)
        {
            Log.v("FragmentManager", (new StringBuilder()).append("Setting back stack index ").append(i1).append(" to ").append(h1).toString());
        }
        k.add(h1);
        this;
        ...
        if (a)
        {
            Log.v("FragmentManager", (new StringBuilder()).append("Adding back stack index ").append(j1).append(" with ").append(h1).toString());
        }
        k.set(j1, h1);
        this;
        JVM INSTR monitorexit ;
...
_L3:
        if (a)
        {
            Log.v("FragmentManager", (new StringBuilder()).append("Adding back stack index ").append(i1).append(" with ").append(h1).toString());
        }
        k.add(h1);
          goto _L4
        Exception exception;
...
_L2:
        if ((fragmentmanagerstate = (FragmentManagerState)parcelable).a != null)
        {
            ...
            if (fragmentmanagerstate.c != null)
            {
                ...
                {
                    h h1 = fragmentmanagerstate.c[j1].a(this);
                    if (a)
                    {
                        Log.v("FragmentManager", (new StringBuilder()).append("restoreAllState: back stack #").append(j1).append(" (index ").append(h1.o).append("): ").append(h1).toString());
                        h1.a("  ", new PrintWriter(new bp("FragmentManager")), false);
                    }
                    i.add(h1);
                    if (h1.o >= 0)
                    {
...
_L4:
        ...
        if (q != null)
        {
            v1 = q.mChildFragmentManager;
        } else
        {
            v1 = o.b;
        }
        fragment.mFragmentManager = v1;
        fragment.mCalled = false;
        fragment.onAttach(o);
        if (!fragment.mCalled)
        {
            throw new az((new StringBuilder()).append("Fragment ").append(fragment).append(" did not call through to super.onAttach()").toString());
        }
        ...
        if (fragment.mFromLayout)
        {
            ...
            if (fragment.mView != null)
            {
                ...
                fragment.mView = aj.a(fragment.mView);
                if (fragment.mHidden)
                {
...
_L11:
        if (i1 < 1)
        {
            ...
            } else
            {
                ...
                if (!fragment.mCalled)
                {
                    throw new az((new StringBuilder()).append("Fragment ").append(fragment).append(" did not call through to super.onDetach()").toString());
                }
                if (!flag)
                {
                    if (!fragment.mRetaining)
        ...
        if (i1 < 2)
        {
            ...
            if (fragment.mView != null && fragment.mContainer != null)
            {
                ...
                if (animation != null)
                {
                    ...
                    fragment.mStateAfterAnimating = i1;
                    animation.setAnimationListener(new x(this, fragment));
        ...
        if (i != null)
        {
            ...
            if (i2 > 0)
            {
                ...
                for (int j2 = 0; j2 < i2; j2++)
                {
                    ...
                    h2.a(s2, filedescriptor, printwriter, as);
                }
...
_L2:
    ...
    public void a(n n1, s s1, Fragment fragment)
    {
        if (o != null)
        {
...
_L6:
        if ((j1 & 1) != 0)
        {
            ...
            do
            {
                ...
                h h2 = (h)i.get(l1);
                if ((s1 == null || !s1.equals(h2.c())) && (i1 < 0 || i1 != h2.o))
                {
                    break;
                }
                l1--;
        ...
        {
            {
                ...
                h h3 = (h)i.get(l1);
                if (s1 != null && s1.equals(h3.c()) || i1 >= 0 && i1 == h3.o)
                {
                    continue; /* Loop/switch isn't completed */
                }
                l1--;
...
label0:
        ...
        if (arraylist != null)
        {
            ...
            if (k1 > 0)
            {
                ...
                for (l1 = 0; l1 < k1; l1++)
                {
                    abackstackstate[l1] = new BackStackState(this, (h)i.get(l1));
                    if (a)
                    {
    ...
    public String toString()
    {
        ...
        if (q != null)
        {
            bo.a(q, stringbuilder);
        } else
        {
            bo.a(o, stringbuilder);
        }
