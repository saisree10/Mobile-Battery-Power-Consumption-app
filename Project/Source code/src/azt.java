...
public class azt
{
    ...
    {
        Log.d("DX-PowerManager", e(s, s1));
    }

    public static void a(String s, String s1, Throwable throwable)
    {
        Log.w("DX-PowerManager", e(s, (new StringBuilder()).append(s1).append(" Exception: ").append(a(throwable)).toString()));
    }

    public static void b(String s, String s1)
    {
        Log.i("DX-PowerManager", e(s, s1));
    }

    public static void b(String s, String s1, Throwable throwable)
    {
        Log.e("DX-PowerManager", e(s, (new StringBuilder()).append(s1).append(" Exception: ").append(a(throwable)).toString()));
    }

    public static void c(String s, String s1)
    {
        Log.w("DX-PowerManager", e(s, s1));
    }

    public static void d(String s, String s1)
    {
        Log.e("DX-PowerManager", e(s, s1));
    }
