...
public class bdi extends bdj
{
    ...
    public bdi(int i1, byte abyte0[])
    {
        this(i1, abyte0, false);
    }

    public bdi(int i1, byte abyte0[], boolean flag)
    {
        int j1;
        if (abyte0 == null)
        {
    ...
    public static byte[] a(byte abyte0[], boolean flag, boolean flag1, int i1)
    {
        ...
        {
            bdi1 = new bdi(0, a, flag1);
        }
        l1 = bdi1.f(abyte0);
        if (l1 > (long)i1)
        {
            throw new IllegalArgumentException((new StringBuilder()).append("Input array too big, the output array would be bigger (").append(l1).append(") than the specified maximum size of ").append(i1).toString());
        } else
        {
            return bdi1.d(abyte0);
        }
    }

    public static byte[] b(byte abyte0[])
    {
        return (new bdi()).c(abyte0);
    }
