...
_L3:
    ...
    public ah a(String s, boolean flag, boolean flag1)
    {
        if (l == null)
        {
            l = new bx();
    ...
    public View onCreateView(String s, Context context, AttributeSet attributeset)
    {
        ...
        TypedArray typedarray = context.obtainStyledAttributes(attributeset, q.a);
        if (s1 == null)
        {
