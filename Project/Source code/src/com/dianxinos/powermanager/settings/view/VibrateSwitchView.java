...
public class VibrateSwitchView extends aph
    implements android.view.View.OnClickListener, apa
{
    ...
    public VibrateSwitchView(Context context, AttributeSet attributeset)
    {
    ...
    private void setIcon(int k)
    {
        if (k == 1 || k == 3)
        {
            ...
            imageview.setImageResource(0x7f0203f7);
            b = 0;
            return;
        } else
        {
            ...
            imageview1.setImageResource(0x7f0203f8);
            b = 1;
            return;
        }
    }
    ...
    public void onClick(View view)
    {
        ...
        apb.a(context, api1, context1.getString(0x7f0a019a));
        if (b == 0)
        {
