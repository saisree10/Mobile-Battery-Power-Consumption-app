...
public class GpsSwitchView extends aph
    implements android.view.View.OnClickListener, apa
{
    ...
    private void setIcon(boolean flag)
    {
        if (flag)
        {
            ...
            imageview1.setImageResource(0x7f0203ea);
            b = 1;
            return;
        } else
        {
            ...
            imageview.setImageResource(0x7f0203fd);
            b = 0;
            return;
        }
    }
    ...
    public void onClick(View view)
    {
        ...
        apb.c(context, ahp1, context1.getString(0x7f0a0199));
        super.onClick(view);
    }
