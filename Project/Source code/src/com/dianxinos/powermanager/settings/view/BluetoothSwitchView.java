...
public class BluetoothSwitchView extends aph
    implements android.view.View.OnClickListener, apa
{
    ...
    private void setIcon(boolean flag)
    {
        if (flag)
        {
            ...
            imageview1.setImageResource(0x7f0203e9);
            b = 1;
            return;
        } else
        {
            ...
            imageview.setImageResource(0x7f0203fc);
            b = 0;
            return;
        }
    }
    ...
    public void onClick(View view)
    {
        ImageView imageview = h;
        com.dianxinos.dxbs.R.drawable _tmp = ly.e;
        imageview.setImageResource(0x7f0203e8);
        TextView textview = i;
        ...
        apb.a(context, ahp1, context1.getString(0x7f0a019f));
        super.onClick(view);
    }
