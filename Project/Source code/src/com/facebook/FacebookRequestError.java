...
_L8:
        return new FacebookRequestError(j, l, i, s, s1, jsonobject2, jsonobject, obj, httpurlconnection);
_L7:
...
_L9:
        ...
        k = jsonobject2.optInt("error_code", -1);
        i = jsonobject2.optInt("error_subcode", -1);
        l = k;
        flag = true;
        continue; /* Loop/switch isn't completed */
_L4:
        if (HTTP_RANGE_SUCCESS.contains(j)) goto _L2; else goto _L11
_L11:
...
_L14:
        FacebookRequestError facebookrequesterror = new FacebookRequestError(j, -1, -1, null, null, jsonobject1, jsonobject, obj, httpurlconnection);
