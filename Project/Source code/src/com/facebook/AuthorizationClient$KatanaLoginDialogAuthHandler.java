...
class this._cls0 extends this._cls0
{
    ...
    private this._cls0 createCancelOrErrorResult(this._cls0 _pcls0, Intent intent)
    {
        ...
        String s3 = (new JSONObject(s1)).getString("error_code");
        s2 = s3;
_L2:
        return com.facebook.this._mth0(_pcls0, s, intent.getStringExtra("com.facebook.platform.status.ERROR_DESCRIPTION"), s2);
