...
.method public attach(Lcom/facebook/widget/GraphObjectAdapter;)V
    ...
    invoke-virtual {v0}, Lcom/facebook/widget/PickerFragment;->getLoaderManager()Laf;
    ...
    invoke-virtual {v0, v1, v2, v3}, Laf;->a(ILandroid/os/Bundle;Lag;)Lba;
...
.method protected onCreateLoader()Lcom/facebook/widget/GraphObjectPagingLoader;
    ...
    invoke-virtual {v1}, Lcom/facebook/widget/PickerFragment;->getActivity()Ln;
