...
.field private static final ag:Leq;
...
.field private aa:Lem;

.field private ab:Lel;

.field private ac:Len;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/ViewPager;->ag:Leq;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->f:Lei;
    ...
    invoke-direct {v0, p0}, Leg;-><init>(Landroid/support/v4/view/ViewPager;)V
...
.method public static synthetic a(Landroid/support/v4/view/ViewPager;)Ldd;
    .locals 1
    .parameter

    .prologue
    .line 84
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->h:Ldd;
...
.method private a(IIII)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/view/ViewPager;->b(I)Lei;
...
.method private a(IZIZ)V
    ...
    .line 557
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->b(I)Lei;
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->Z:Lem;
    ...
    invoke-interface {v0, p1}, Lem;->a(I)V

    .line 569
    :cond_0
    if-eqz p4, :cond_1

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->aa:Lem;
    ...
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->Z:Lem;
    ...
    invoke-interface {v2, p1}, Lem;->a(I)V

    .line 576
    :cond_3
    if-eqz p4, :cond_4

    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->aa:Lem;
...
.method private a(Lei;ILei;)V
    ...
    .line 1143
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->h:Ldd;

    invoke-virtual {v5, v2}, Ldd;->c(I)F
    ...
    .line 1183
    iget-object v9, p0, Landroid/support/v4/view/ViewPager;->h:Ldd;

    add-int/lit8 v2, v1, -0x1

    invoke-virtual {v9, v1}, Ldd;->c(I)F
...
.method private a(Z)V
    ...
    .line 1752
    iget-boolean v5, v0, Lei;->c:Z

    if-eqz v5, :cond_2

    .line 1754
    iput-boolean v2, v0, Lei;->c:Z
...
.method private b(Z)V
    ...
    invoke-static {v4, v0, v5}, Ldj;->a(Landroid/view/View;ILandroid/graphics/Paint;)V
...
.method private b(F)Z
    ...
    .line 2085
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->R:Lfl;
    ...
    .line 2091
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->S:Lfl;
...
.method private d(I)Z
    ...
    .line 1640
    :cond_0
    invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->l()Lei;
...
.method private k()V
    ...
    sget-object v1, Landroid/support/v4/view/ViewPager;->ag:Leq;
...
.method private l()Lei;
    ...
    .line 2122
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->f:Lei;
    ...
    .line 2125
    iget-object v6, p0, Landroid/support/v4/view/ViewPager;->h:Ldd;

    iget v7, v0, Lei;->b:I

    invoke-virtual {v6, v7}, Ldd;->c(I)F
...
.method private setScrollState(I)V
    ...
    .line 393
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ac:Len;
    ...
    invoke-interface {v0, p1}, Lem;->b(I)V
...
.method a(II)Lei;
    ...
    .line 832
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->h:Ldd;

    invoke-virtual {v1, p0, p1}, Ldd;->a(Landroid/view/ViewGroup;I)Ljava/lang/Object;

    move-result-object v1

    iput-object v1, v0, Lei;->a:Ljava/lang/Object;

    .line 833
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->h:Ldd;

    invoke-virtual {v1, p1}, Ldd;->c(I)F
...
.method a(Landroid/view/View;)Lei;
    .locals 4
    .parameter
    ...
    .line 1328
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->h:Ldd;

    iget-object v3, v0, Lei;->a:Ljava/lang/Object;

    invoke-virtual {v2, p1, v3}, Ldd;->a(Landroid/view/View;Ljava/lang/Object;)Z
...
.method a()V
    ...
    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->R:Lfl;
    ...
    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->S:Lfl;
    ...
    invoke-direct {v0, p0}, Lek;-><init>(Landroid/support/v4/view/ViewPager;)V
    ...
    .line 376
    invoke-static {p0, v4}, Ldj;->b(Landroid/view/View;I)V
...
.method a(I)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/v4/view/ViewPager;->b(I)Lei;
    ...
    iget-object v2, v0, Landroid/support/v4/view/ViewPager;->h:Ldd;
    ...
    invoke-virtual {v2, v0}, Ldd;->a(Landroid/view/ViewGroup;)V
    ...
    iget-object v5, v0, Landroid/support/v4/view/ViewPager;->h:Ldd;

    invoke-virtual {v5}, Ldd;->b()I
    ...
    iget-object v4, v0, Landroid/support/v4/view/ViewPager;->h:Ldd;
    ...
    invoke-virtual {v0, v2, v5}, Landroid/support/v4/view/ViewPager;->a(II)Lei;
    ...
    invoke-direct {v0, v10, v8, v4}, Landroid/support/v4/view/ViewPager;->a(Lei;ILei;)V
    ...
    iget-object v2, v10, Lei;->a:Ljava/lang/Object;

    :goto_d
    move-object/from16 v0, p0

    invoke-virtual {v4, v0, v5, v2}, Ldd;->b(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v2, v0}, Ldd;->b(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lei;
    ...
    iget-object v15, v0, Landroid/support/v4/view/ViewPager;->h:Ldd;

    iget-object v2, v2, Lei;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v15, v0, v9, v2}, Ldd;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v9, v2}, Landroid/support/v4/view/ViewPager;->a(II)Lei;
    ...
    iget-object v11, v0, Landroid/support/v4/view/ViewPager;->h:Ldd;

    iget-object v2, v2, Lei;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v11, v0, v9, v2}, Ldd;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v9, v7}, Landroid/support/v4/view/ViewPager;->a(II)Lei;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->b(Landroid/view/View;)Lei;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lei;
...
.method protected a(IFI)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lem;->a(IFI)V
    ...
    .line 1728
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->ac:Len;

    invoke-interface {v5, v3, v0}, Len;->a(Landroid/view/View;F)V
...
.method a(III)V
    ...
    invoke-virtual {v5, v6}, Ldd;->c(I)F
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    .line 2634
    invoke-virtual {p0, v3}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lei;
...
.method public addTouchables(Ljava/util/ArrayList;)V
    ...
    .line 2676
    invoke-virtual {p0, v1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lei;
...
.method b(Landroid/view/View;)Lei;
    .locals 2
    .parameter
    ...
    .line 1343
    :cond_2
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lei;
...
.method public b()V
    ...
    .line 854
    iget-object v7, p0, Landroid/support/v4/view/ViewPager;->h:Ldd;

    iget-object v9, v0, Lei;->a:Ljava/lang/Object;

    invoke-virtual {v7, v9}, Ldd;->a(Ljava/lang/Object;)I
    ...
    .line 865
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->h:Ldd;

    invoke-virtual {v4, p0}, Ldd;->a(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v6, p0, v7, v9}, Ldd;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, p0}, Ldd;->b(Landroid/view/ViewGroup;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 2185
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->R:Lfl;

    invoke-virtual {v4, v2, v3}, Lfl;->a(II)V

    .line 2186
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->R:Lfl;
    ...
    .line 2189
    :cond_1
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->S:Lfl;
    ...
    .line 2196
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->S:Lfl;
...
.method public e()V
    ...
    invoke-static {v0, v1}, Lde;->a(Landroid/view/VelocityTracker;I)F
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Lej;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v0, Landroid/support/v4/view/ViewPager;->h:Ldd;
    ...
    iget-object v3, v0, Landroid/support/v4/view/ViewPager;->h:Ldd;

    invoke-virtual {v3, v5}, Ldd;->c(I)F
...
.method public onLayout(ZIIII)V
    ...
    .line 1570
    iget-boolean v10, v1, Lej;->a:Z

    if-nez v10, :cond_2

    move-object/from16 v0, p0

    invoke-virtual {v0, v8}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lei;
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    .line 2706
    invoke-virtual {p0, v5}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lei;
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v0, v1, v2}, Ldd;->a(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {v0}, Ldd;->a()Landroid/os/Parcelable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 2019
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->R:Lfl;
...
.method public setAdapter(Ldd;)V
    ...
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->n:Leo;

    invoke-virtual {v0, v1}, Ldd;->b(Landroid/database/DataSetObserver;)V

    .line 410
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->h:Ldd;

    invoke-virtual {v0, p0}, Ldd;->a(Landroid/view/ViewGroup;)V
    ...
    .line 413
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->h:Ldd;

    iget v4, v0, Lei;->b:I

    iget-object v0, v0, Lei;->a:Ljava/lang/Object;

    invoke-virtual {v3, p0, v4, v0}, Ldd;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    .line 423
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->h:Ldd;
    ...
    invoke-direct {v1, p0, v5}, Leo;-><init>(Landroid/support/v4/view/ViewPager;Lee;)V

    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->n:Leo;

    .line 430
    :cond_2
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->h:Ldd;

    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->n:Leo;

    invoke-virtual {v1, v3}, Ldd;->a(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {v1, v3, v4}, Ldd;->a(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
    ...
    :cond_3
    :goto_1
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->ab:Lel;
    ...
    invoke-interface {v1, v0, p1}, Lel;->a(Ldd;Ldd;)V
...
.method setOnAdapterChangeListener(Lel;)V
    .locals 0
    .parameter

    .prologue
    .line 474
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->ab:Lel;

    .line 475
    return-void
.end method

.method public setOnPageChangeListener(Lem;)V
    .locals 0
    .parameter

    .prologue
    .line 592
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->Z:Lem;
